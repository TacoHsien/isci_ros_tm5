...
void Manual_Fun()
{
	...
	LoadPCD("CADObject_1_theta_0_phi_0.pcd", CADDatabaseObj.getCADModelCloud() );
	voxelGrid_Filter( CADDatabaseObj.getCADModelCloud(), CADDatabaseObj.getDownsampling_CADModelCloud(), CADModel_Voxel_radius );
	DisplyXYZPCDbyXYZRGB( CADDatabaseObj.getDownsampling_CADModelCloud(), point_color,  background_color,1);
	SavePCD(  CADDatabaseObj.getDownsampling_CADModelCloud(), "VirtualObject_1_CADModel_PCD.pcd");
